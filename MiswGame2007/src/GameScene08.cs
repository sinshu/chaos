...
{
    public class GameScene08 : GameScene
    {
        ...
        public GameScene08(StageData data)
            : base(data)
        {
        ...
        public GameScene08(StageData data, PlayerState playerState)
